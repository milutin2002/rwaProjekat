...
export class CampgroundEffects{
    ...
    loadCampgrounds=createEffect(()=>this.actions$.pipe(ofType(CampgroundActions.loadCampgrounds),mergeMap((a)=>this.campgroundService.getCampgrounds(a.admin,a.page,a.pageSize,a.search).pipe(map((camps)=>CampgroundActions.loadCampgroundsSuccess({campgrounds:camps}))))))
